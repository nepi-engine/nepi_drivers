...
class RBXFakeGPS:
  ...
  def fakeGPSGoPosCb(self,enu_point_msg):
    if self.fake_gps_enabled:
      ...
      rospy.loginfo("RBX_FAKE_GPS: At Geo Location Message: " + geo_str)
      ...
      geo_str = str (self.current_location_wgs84_geo)
      rospy.loginfo("RBX_FAKE_GPS: Current Geo Location Message: " + geo_str)
      geo_str = str (new_geopoint_wgs84)
      rospy.loginfo("RBX_FAKE_GPS: New Geo Location Message: " + geo_str)
