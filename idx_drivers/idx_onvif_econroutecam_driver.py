...
from idx_onvif_generic_driver import GenericONVIF_NVT

PKG_NAME = 'IDX_ONVIF_EconRoute' # Use in display menus
FILE_TYPE = 'DRIVER' 
CLASS_NAME = 'EConRouteCam_NVT' # Should Match Class Name
...
class EConRouteCam_NVT(GenericONVIF_NVT):
    ...
    def __init__(self, username, password, ip_addr, onvif_port=8000):
        super(EConRouteCam_NVT, self).__init__(username, password, ip_addr, onvif_port)
    ...
    def getAvailableResolutions(self, video_encoder_id=0):
        ...
        return True, available_resolutions, self.encoder_cfg # Convenient to return the encoder config, too
