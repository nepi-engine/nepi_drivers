...
FILE_TYPE = 'DRIVER'
CLASS_NAME = 'GenericONVIF_NVT' # Should Match Class Name
...
class GenericONVIF_NVT(object):
    ...
    def hasAdjustableResolution(self):
        _, resolutions, _ = self.getAvailableResolutions()
...
if __name__ == '__main__':
    ...
    driver = GenericONVIF_NVT(username="admin", password="SN:5364", ip_addr="192.168.0.150", port=80)
    ...
    _, available_resolutions, _ = driver.getAvailableResolutions()
