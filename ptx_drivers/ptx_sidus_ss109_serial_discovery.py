...
class SidusSS109SerialDiscovery:
  ...
  def discoveryFunction(self,available_paths_list, active_paths_list,base_namespace,drv_dict):
    ...
    if active_paths_list != self.active_paths_list:
      self.logger.log_warn("Discovery function got updated active_paths_list: " + str(active_paths_list))
      ...
      for baud_str in self.baudrate_list:
        ...
        for addr_str in self.addr_search_list:
          ...
          for i in range(self.data_len):
            data_str = data_str + '0'
          ser_msg= ('#' + addr_str + 'MRA' + data_str + 'R')
          ser_str = (ser_msg + '\r\n')
